...
namespace MultimediaTimer
{
	...
	{
		static AccurateTimer mTimer1, mTimer2, mTimer3;
		...
		static void Main()
		{
			...
			delay = 1;      // 100 = 1/10th second.
			mTimer3 = new AccurateTimer(new Action(TimerTick3), delay);
		...
		static private void TimerTick3()
		{
			// Put your second timer code here!
		}
	}
